...
export class Backend implements backendInterface {
    ...
    async getPlayerProgress(arg0: Principal): Promise<PlayerProgress> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayerProgress(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetLevel(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetLevel(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAnswers(arg0: bigint, arg1: Array<Answer>): Promise<SubmissionResult> {
        if (this.processError) {
            try {
